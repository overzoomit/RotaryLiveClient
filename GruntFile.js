module.exports = function(grunt) {
    ...
    gtx.alias('build', ['compass:standardversion', 'clean:standardversion', 'copy:standardversion', 'concat:standardversion', 'cssmin:standardversion']); //, 'uglify:standardversion'
