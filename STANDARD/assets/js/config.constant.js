...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        'clubCtrl': ['assets/js/controllers/clubCtrl.js'],
        'eventCtrl': ['assets/js/controllers/eventCtrl.js'],

        
        //*** Services
        'user': 'assets/js/services/user.js',
        'shareObjectService': 'assets/js/services/shareobject.js',
        'club': 'assets/js/services/club.js',
        'event': 'assets/js/services/event.js',
